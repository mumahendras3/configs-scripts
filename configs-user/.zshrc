...
# set theme according to terminal capabilities
if [[ $TERM == "linux" ]]; then
	ZSH_THEME="gentoo"
else
	ZSH_THEME="agnoster"
...
# start sourcing oh-my-zsh
source $ZSH/oh-my-zsh.sh

# User configuration

# to hide username and local computer name
# when using agnoster theme
DEFAULT_USER=mumahendras3
prompt_context(){}
